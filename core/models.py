...
class Order(models.Model):
    ...
    payment = models.ForeignKey(
        'mpesapayment', on_delete=models.SET_NULL, blank=True, null=True)
...
class Payment(models.Model):
    mpesa_transaction_id = models.CharField(max_length=50)
    user = models.ForeignKey(settings.AUTH_USER_MODEL,
...
class mpesapayment(models.Model):
    ...
    ResultDesc = models.CharField(max_length=50)
    CheckoutRequestID = models.CharField(max_length=50)
    # status = models.CharField(choices=STATUS_CHOICEs, Null=False, max_length=1)
