# Generated by Django 2.2 on 2019-11-22 14:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.CharField(choices=[('seat', 'seat'), ('tents', 'tents'), ('catering', 'catering'), ('Toilets', 'toilets')], max_length=100)),
        ...
        migrations.AddField(
            model_name='order',
            name='payment',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.mpesapayment'),
        ),
        migrations.AddField(
            model_name='order',
